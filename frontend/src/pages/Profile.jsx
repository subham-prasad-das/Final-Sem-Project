...
const Profile = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="min-h-[80vh] px-8 md:px-20 mt-8 flex md:flex-row flex-col-reverse items-start">
        <div className="flex flex-col md:w-[70%] w-full mt-8 md:mt-0">
          <h1 className="text-xl font-bold mb-4"><button className="bg-[#4682b4] hover:bg-blue-800 text-white font-bold py-2 px-4 rounded">
        Your Posts:
      </button></h1>
        ...
        <div className="md:sticky md:top-12 flex justify-start md:justify-end items-start md:w-[30%] w-full md:items-end">
          <div className="flex flex-col space-y-4 items-start bg-white p-4 rounded-lg shadow-lg">
            <h1 className="text-xl font-bold mb-4">Profile</h1>
            <input 
              onChange={(e) => setUsername(e.target.value)} 
              value={username} 
              className="outline-none px-4 py-2 border border-gray-300 rounded-lg w-full" 
            ...
            <div className="flex items-center space-x-4 mt-4">
              <button 
                ...
                className="text-white font-semibold bg-black px-4 py-2 rounded-lg hover:bg-gray-700"
              >
                Update
              </button>
              <button 
                onClick={handleUserDelete} 
                className="text-white font-semibold bg-red-500 px-4 py-2 rounded-lg hover:bg-red-700"
              >
                Delete
              </button>
            </div>
